        ...
        <div className="footer-wrapper">
            <div className="footer-logo-column">
                    <a href="/" className="w-inline-block">
                        ...
                        <div>
                        <a href="https://twitter.com/webflow"  className="social-footer-link w-inline-block">
                        ...
                        <a href="https://www.instagram.com/webflow/"  className="social-footer-link w-inline-block">
                ...
                <div className="footer-bottom-wrapper">
                    <div className="small footer-small">Made In <a href="https://webflow.com">Webflow</a>. © 2020.</div>
                </div>
            </div>
        </div>
        </>
