                ...
                <div className="content-section">
                    <div className="container">
                        <div className="shopping-page-wrapper">
                            ...
                            <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr.url%22%2C%22to%22%3A%22style.background-image%22%7D%5D" style={{backgroundImage: "url('https://assets.website-files.com/5e853c3383474026e43f2c78/5e8542c1248e59128e08e3e9_ryan-holloway-JyDmUaXMib4-unsplash.jpg')"}} class="shopping-page-image">
                            ...
                            <div className="shipping-page-right">
                                    <h2 className="page-product-headin">Tin Coffee Tumbler</h2>
                                    <div className="page-price-wrapping">
                                        <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D" className="shop-item-price-page">$&nbsp;35.00&nbsp;USD</div>
