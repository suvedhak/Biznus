                    ...
                    <div className="container">
                        <div className="shopping-page-wrapper">
                            <div className="shopping-page-left">
                                <div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr.url%22%2C%22to%22%3A%22style.background-image%22%7D%5D" style={{backgroundImage: "url('https://assets.website-files.com/5e853c3383474026e43f2c78/5e861d123df4d175e80e8beb_acme-gift-card.jpg')"}} className="shopping-page-image">
                            ...
                            <div className="shipping-page-right">
                                    <h2 className="page-product-headin">Gift Card</h2>
                                ...
                                <div>
                                        <form data-node-type="commerce-add-to-cart-form" data-commerce-sku-id="5e861d45022dd3619ea90064" data-loading-text="Adding to cart..." data-commerce-product-id="5e861d4511e8ae22e0f08ccb" className="w-commerce-commerceaddtocartform">
                                            ...
                                            <div className="add-to-cart-page-wrapper">
                                                ...
                                                <input type="submit" onClick={count = count++} value="Add To Cart" data-node-type="commerce-add-to-cart-button" data-loading-text="Adding to cart..." className="w-commerce-commerceaddtocartbutton btn outline"/>
                                            </div>
                                        </form>
